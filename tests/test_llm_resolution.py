...
def test_provider_and_api_key_come_from_model_contract() -> None:
    cfg = resolve_llm_config({"LLM_MODEL": "gemini/gemini-2.0-flash", "GEMINI_API_KEY": "g-key"})
...
def test_uses_generic_api_key_for_unmapped_provider() -> None:
    cfg = resolve_llm_config({"LLM_MODEL": "vertex_ai/gemini-2.0-flash", "LLM_API_KEY": "v-key"})
